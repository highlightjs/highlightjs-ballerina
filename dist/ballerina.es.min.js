...
begin:/\$\{/,end:/\}/,excludeBegin:!0,excludeEnd:!0}]},o={scope:"string",
begin:"'",end:"'",illegal:"\\n",contains:[e.BACKSLASH_ESCAPE,{match:t,
relevance:0}],relevance:0},s={scope:"string",begin:'"',end:'"',illegal:"\\n",
contains:[e.BACKSLASH_ESCAPE,{match:t,relevance:0}]},l={scope:"string",
variants:[o,s,c]},b={scope:"number",
begin:/(-?)(\b0[xX][a-fA-F0-9]+|(\b\d+((?<!\.)\.(?!\.)\d*)?|(?<!\.)\.(?!\.)\d+)([eE][-+]?\d+)?)/,
relevance:0},d={scope:"number",variants:[b,e.BINARY_NUMBER_MODE]},p={
scope:"operator",
match:/(!|%|\+|\-|\*|~=|===|==|=|!=|!==|<|>|&|\||\?:|\.\.\.|<=|>=|&&|\|\||~|>>|>>>)/,
relevance:0},g={variants:[{
...
contains:["self",e.C_LINE_COMMENT_MODE,g,d,l]},m={variants:[{
...
begin:/\w+/}],relevance:0}],relevance:0},u,g,e.C_LINE_COMMENT_MODE,d,l,m,{
scope:"meta.arrow.ballerina storage.type.function.arrow.ballerina",match:/(=>)/
},p,{begin:/xml\s*`/,end:/`/,excludeBegin:!0,excludeEnd:!0,subLanguage:"xml",
relevance:2},{begin:/import (?:ballerina|ballerinax)\/[a-z]+/,keywords:"import",
relevance:4}]}}})();export default hljsGrammar;